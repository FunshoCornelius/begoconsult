...
/**
 * ServicesHero — full-bleed background image hero for the services listing page.
 */
export default function ServicesHero() {
  return (
    ...
    >
      <Image
        src="https://images.unsplash.com/photo-1497215842964-222b430dc094?w=1920&auto=format&fit=crop&q=80"
        alt=""
        fill
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-28 md:py-36">
        ...
        >
          ...
          >
            From staffing and training to custom software development, we
            deliver integrated IT services that power your business forward.
          </motion.p>
        </motion.div>
      </div>
